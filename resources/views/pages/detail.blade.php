...
@section('content')
  ...
  <div class="page-content page-details">
    ...
    <div class="store-details-container" data-aos="fade-up">
      ...
      <section class="store-rivew">
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-8 mt-3 mb-3">
              <h5>Customer Rivew (3)</h5>
            </div>
          </div>
          <div class="row">
            <div class="col-12 col-lg-8">
              <ul class="list-unstyled">
                ...
                <li class="media">
                  ...
                  <div class="media-body">
                    ...
                    When I saw first, it was really awesome to have with. Just let me know if there is another upcoming product like this.
                  </div>
                </li>
              </ul>
            </div>
